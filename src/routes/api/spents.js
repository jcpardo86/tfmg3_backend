...
const { getSpentsByGroup, getTotalSpentByGroup, getCuentas, createSpent, updateSpent, deleteSpent, getSpentById, updateSaldo} = require('../../controllers/spents.controller');
