...
const { getGroupsByUser, getGroupById, createGroup, updateGroup, deleteGroup, getUsersByGroup, addUserToGroup, updateStatusGroup, getStatus } = require('../../controllers/groups.controller');
